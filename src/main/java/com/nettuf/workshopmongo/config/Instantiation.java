...
import com.nettuf.workshopmongo.dto.AuthorDTO;
import com.nettuf.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null,sdf.parse("23/03/2018") , "Bom dia", "que dia lindo",new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa viagem", sdf.parse("21/03/2018"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Saudades", sdf.parse("21/04/2018"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Aproveite", sdf.parse("11/05/2018"), new AuthorDTO(alex));
